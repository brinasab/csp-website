...
subtitle: "<b>Topics:</b> Course Logistics, R, Markdown"
...
| Role | Name | Email | Office Hours | Contact Method |
|---------------|---------------|---------------|---------------|---------------|
| Instructor | [Sabrina Nardin](https://macss.uchicago.edu/directory/Sabrina-Nardin) | nardin\@uchicago.edu | Tue & Thu, 2:30–3:30 PM (after class) | Email or OHs |
| Teaching Assistant | Zach Meyer | zmeyer\@uchicago.edu | TBD | Email or OHs |
...
-   Email us for course-related concerns
-   Use the course platform for slides, class materials, etc.
:::
...
See [Evaluation Guidelines](https://computing-soc-sci.netlify.app/faq/homework-evaluations/) in the course website and see the [Course Schedule](add%20link):

-   Assignments and in-class quizzes
-   Arrive on time (there will be a short quiz at the start of every class)
...
```{=html}
<!-- IN CLASS: 
Ask how many have completed the set up already -->
```
...
1.  Use RStudio Workbench (required for beginners; strongly recommended for others)
2.  Install the software locally on your own machine (talk to me if you plan to do so)
...
-   Any questions or concerns you have, and strategies you plan to use to stay on track (we’ll go around the room)

If there is time left after you are done discussing with your group, please complete [this short survey](ADD%20LINK) (if you haven’t done it yet!)
...
See our [Course Expectations](https://computing-soc-sci.netlify.app/faq/course-obj-expectations/) under FAQ:
...
| Posit **Workbench** | A cloud-based version of R/RStudio with everything pre-installed. We will use it in this course to minimize setup issues. |
...
You might hear about Quarto (with extension `.qmd`), which is a newer alternative to R Markdown. We won’t cover it, but if you know R Markdown, you can quickly adjust to Quarto.
...
::: fragment
But what do we see what we "Render" this R Markdown document?
...
\_ **Use `render()`** in your console by typing `rmarkdown::render("my-document.Rmd", output_format: html_document`). More info [here](https://pkgs.rstudio.com/rmarkdown/reference/render.html)
:::
...
-   Log into **Workbench** ADD LINK
-   Download today’s materials from Lecture 1 on our website
-   Complete the R Markdown in-class practice
-   Want more? Try the interactive tutorial linked under Lecture 1
