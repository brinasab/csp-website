...
-   **Assessment and Evaluation:**  There will be short quizzes in class and take-home assignments. Check the syllabus for the grading rubric and more details
-   **Arrive on Time:** Each class starts right at 1:00 PM with a quick quiz. These are short and meant to help you stay on track, so be here and ready to go by 1:00 PM.
...
We’ll be working in **RStudio Workbench**, which is cloud-based version of RStudio that runs in your browser. 
...
-   Any questions or concerns you have, and strategies you plan to use to stay on track (we’ll go around the room and answer questions)
