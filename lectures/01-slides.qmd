...
ADD HERE A MORE STRONGER AI STATEMTN WITH A SLIDE THAT TITLES LET'S TALK ABOUT AI OR SO

share that I think is my responsibility to set expectations and draw boundaries on what is an acceptable vs not use of AI
(e.g. not sloppinnes, no using AI to replace thinking, reading text, going through slides etc.) and enforce it (e.g. linked yo your grading and assessment system, e.g/ AI statment, exercise using both AI and slides/books etc.)

it is your resonsiblity to ask questions if smt is not clear, comply with instructions, and provide feedbakc if smt is not working to improve it, do not plagiariz
