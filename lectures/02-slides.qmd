...
subtitle: "<b>Topics:</b> Git/GitHub with RStudio"
...
::: {.column width="42%"}
### Why use programming for data analysis and version control to automatically keep track of changes in your work
...
::: {.column width="44%"}
### using point-and-click software for data analysis, and and saving multiple copies of your work by hand to keep track of changes?
...
_ **Push regularly** to keep your GitHub repo in sync  
...
- Homework 1 opened today. Due next week (check Course Schedule for exact dates)
- 