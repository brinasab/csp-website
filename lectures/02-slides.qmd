...
- Tracks changes in a folder called **repository** or **repo**
- You work in that folder (your **local repo**)
...
- Git (your version control software, operates locally on your machine) *and*
- GitHub (your online storage/backup)
...
| What it does            | Tracks and saves changes in your local repo | Hosts a remote copy of your local repo for backup and sharing with others  |
| Collaboration           | Not built-in                                   | Yes, supports pull requests, issues, and code review          |
| How to use with RStudio | Git panel for staging, committing, and pushing  | Connect to GitHub via RStudio’s project setup or terminal|
| Repo terminology        | Your working folder is a **local repo**        | The online copy is a **remote repo** |

Note: we use **Git and GitHub via RStudio** only. They are also used with other tools like GitHub Desktop, terminal, etc.

---

## Okay, that was a lot of info. Let’s try it out with some practice!

#### We practice in two steps: 

#### 1. Configure Setup
#### 2. Use Git and GitHub in RStudio Tutorial

---

## 💻 Step 1: Configure your Setup

### Complete the RStudio Workbench Setup:
...
### Once step 1 is done, complete this tutorial:
...
- Keep track of questions as you go and post them in [this Google doc](https://docs.google.com/document/d/1iQacRXqGLpke1D6qm_-kBkHBtrZy7SJYtRzFR88-Y_I/edit?usp=sharing)
...
These slides won't be included in the in-class quiz, but they might be handy if you run into problems in homework assigments.
...
- If you haven't completed these yet, please do so ASAP, as you won't be able to access and complete Homework 1 otherwise:
  ...
  - Setup your computer (see Lecture 2 on our website and these slides)
