...
- Define what good coding style means
- Apply good coding style practices when writing R code
...
Additional Resources (not needed for quizzes or homework but helpful if you want to know more about these topics):
