...
- Knit your `.Rmd` file to `md_document` and push **both** files to GitHub  
...
- Includes **intuitive, clearly named functions** for common tasks:
  - `filter()` — filter rows
  - `select()` — pick columns
  - `summarize()` — calculate summaries (e.g., averages)
