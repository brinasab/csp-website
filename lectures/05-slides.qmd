...
TASK 1: Display the annual total cost of school attendance across the U.S. (variable `cost`)

TASK 2: Display the total number of schools in the U.S. by school type (variable `type`)

TASK 3: Display the annual total cost and net cost of attendance to schools in the U.S. (variables `cost` and `netcost`)

TASK 4: Display the annual total cost of attendance by school type (variables `cost` and `type`)

TASK 5: Display the annual total cost of attendance and net cost of attendance by school type (variables `cost`, `netcost`, `type`)
