...
This tutorial verifies that everything is working as expected. To be completed **after** the [RStudio Workbench Setup](setup-workbench.qmd) tutorial.
...
- Go to [GitHub](https://www.github.com) and log in. If you haven’t already, sign up for an account, create your profile, and share your GitHub username with us (use the file linked in Lecture 1).
