...
Add your GitHub username to the Excel file linked on [Lecture 1](../lectures/01-home.qmd). We’ll use it to invite you to our GitHub Course Organization, which is required to access and submit homework assignments. Once added, you’ll receive an invitation email from GitHub — make sure to open it and accept the invitation to join the organization.
