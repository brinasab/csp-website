...
3. We’ll use it to invite you to our GitHub Course Organization, which is required to access and submit homework assignments. Once we have your username, you’ll receive an invitation email from GitHub — make sure to open it and accept the invitation to join the organization.
