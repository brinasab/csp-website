...
For Course Information (instructor, emails, Office Hours, etc.) see [Home](index.qmd).
...
See the [course schedule](https://docs.google.com/spreadsheets/d/1CmuUXTp0uvhAVk3mmOQMEfb8BjdR-I36/edit?usp=sharing&ouid=112534119211880791899&rtpof=true&sd=true) for details. The course schedule might be subject to change, but if changes occur students will be promptly informed.
...
### Detailed Breakdown (100 total possible points):
...
If more than 25% of an assignment is missing, it will not be graded and will be treated as a missed assignment (see above). If less than 25% is missing but the assignment is not fully completed, the assignment will be graded with a penalty for each incomplete element based on the rubric.
...
Regular attendance is expected. Please inform the instructor in advance if you must miss a class. A maximum of two class sections can be missed without penalty. Class starts at 1 PM promptly. If you are late more than 3 times you will not receive credits for attendance.

### Accommodations

Students requiring accommodations should contact the instructor and the university's disability services at the beginning of the term (more info below).
...
### Accessibility, Support, and Inclusive Learning
